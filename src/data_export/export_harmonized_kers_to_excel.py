...
from src.utilities import get_single_aopwiki_url
...
if __name__ == "__main__":
    # Example usage
    harmonized_ker_json_path = "outputs/tabulated_ker_evidence/harmonized_ker_evidence_2025-12-22.json"
    harmonized_ker_data = json.load(open(harmonized_ker_json_path, 'r', encoding='utf-8'))
    
    output_excel_path = "outputs/tabulated_ker_evidence/harmonized_ker_evidence_2025-12-22.xlsx"
