...
from src.parsers import collect_references_from_aops_kers_and_events, get_structured_references
...
from src.data_export import export_search_results_to_csv
...
def _load_structured_references(today):
    ...
    parsed_refs_path = f'outputs/reference_search_results/parsed_references_{today}.json'
    ...
    if not os.path.exists(parsed_refs_path):
        ...
        write_dict_to_json(references_for_core_entities, 'outputs/reference_search_results/', f'references_for_core_entities_{today}.json')
        ...
        write_dict_to_json(structured_references, 'outputs/reference_search_results/', f'parsed_references_{today}.json')
    else:
        import json
