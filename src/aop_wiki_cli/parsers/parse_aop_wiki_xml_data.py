...
from aop_wiki_cli.utilities import write_dict_to_json, generic_cache_wrapper
...
from aop_wiki_cli.analysis import apply_ranking_to_events_dict
...
if __name__ == '__main__':
    ...
    output_dir = outputs_dir('test_collections', today_str)
