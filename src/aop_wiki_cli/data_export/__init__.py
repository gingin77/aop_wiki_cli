...
Usage:
    from aop_wiki_cli.data_export import write_csv, AOP_FIELDS_MIN
    
    write_csv(
        data=aop_dict,
        field_config=AOP_FIELDS_MIN,
        output_path=outputs_dir() / 'aops.csv',
...
from aop_wiki_cli.data_export.export_reference_search_results import (
