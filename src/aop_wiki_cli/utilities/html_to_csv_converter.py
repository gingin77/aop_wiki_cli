...
from aop_wiki_cli.paths import inputs_dir, outputs_dir
...
if __name__ == '__main__':
    convert_html_to_csv(
        inputs_dir("from_emod_prototypes") / "ker_2937_evidence_map_2.html",
        outputs_dir("tabulated_ker_evidence") / "ker_2937_evidence_map_2.csv"
    )
