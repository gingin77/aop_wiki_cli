...
from aop_wiki_cli.search.result_processors import serialize_search_results
...
def screen_aop_wiki_fields_for_input_terms(entity, input_search_params, content_to_drop_by_field=None, 
                                           work_date=None, output_dir=None, 
    ...
    :param output_dir: Directory for cache files (defaults to the resolved search cache)
    ...
    output_dir = output_dir if output_dir is not None else outputs_dir('search_cache')
    content_to_drop_by_field = content_to_drop_by_field or {}
