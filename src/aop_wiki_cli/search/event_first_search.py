...
from aop_wiki_cli.parsers import collect_events_from_xml, collect_aops_from_xml, collect_entity_with_cache
from aop_wiki_cli.paths import cache_root
from aop_wiki_cli.search.search_text_by_field import build_term_pattern, parse_and_clean_text
...
def search_events_to_aops(search_params, work_date=None, cache_dir=None,
    ...
    Args:
        ...
        cache_dir: Directory for cache files (defaults to the resolved cache root)
    ...
    cache_dir = cache_dir if cache_dir is not None else cache_root()
